...
var _jsxFileName = "C:\\Users\\retbr\\IdeaProjects\\pizzamasterreact\\src\\pages\\_document.tsx";
...
class Document extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    ...
    const materialUiSheet = new _material_ui_styles__WEBPACK_IMPORTED_MODULE_3__["ServerStyleSheets"]();
    const originalRenderPage = ctx.renderPage;

    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => styledComponentSheet.collectStyles(materialUiSheet.collect(__jsx(App, _extends({}, props, {
          __source: {
      ...
      return _objectSpread({}, initialProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, initialProps.styles, materialUiSheet.getStyleElement(), styledComponentSheet.getStyleElement())
      });
    } finally {
